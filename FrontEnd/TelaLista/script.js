...
function criarLinha(assinante) {
  ...
  colunas.forEach((coluna) => {
    ...
    td.classList.add("align-middle", "text-wrap", "text-truncate"); // Adiciona a classe para truncar o texto
    td.style.maxWidth = "260px"; // Define um tamanho máximo para a célula
    tr.appendChild(td);
  });
...
tdAcoes.classList.add(
  ...
  "align-items-center",
  "p-5",
  "align-middle", // Adiciona a classe para alinhamento vertical
  "text-wrap", // Adiciona a classe para quebra de texto
  "text-truncate" // Adiciona a classe para truncar o texto
);
tdAcoes.style.maxWidth = "230px"; // Define um tamanho máximo para a célula

const divAcoes = document.createElement("div");
divAcoes.style.overflowX = "auto" // Define um tamanho máximo para a célula
  // Remov
...
// Criar um elemento span para agrupar o texto e o ícone
const spanExcluir = document.createElement("span");
spanExcluir.style.display = "flex";
spanExcluir.style.alignItems = "center";

// Criar o elemento SVG para o ícone de lixeira
const svgIconExcluir = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
const pathIconExcluir1 = document.createElementNS("http://www.w3.org/2000/svg", "path");
pathIconExcluir1.setAttribute("d", "M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z");

const pathIconExcluir2 = document.createElementNS("http://www.w3.org/2000/svg", "path");
pathIconExcluir2.setAttribute("d", "M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z");
...
const svgIconVer = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
const pathIconVer1 = document.createElementNS("http://www.w3.org/2000/svg", "path");
pathIconVer1.setAttribute("d", "M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z");

const pathIconVer2 = document.createElementNS("http://www.w3.org/2000/svg", "path");
pathIconVer2.setAttribute("d", "M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0");
...
linkVer.href = "#";
linkVer.classList.add("btn", "btn-outline-info", "btn-sm", "d-flex", "align-items-center");
...
// Índice do assinante atualmente exibido
var indiceAtual = 0;
var assinantes = [];
...
// Mudar para o assinante anterior quando o botão de controle anterior é clicado
...
// Mudar para o próximo assinante quando o botão de controle próximo é clicado
